...
namespace DirectoryService.Domain.DepartmentPositions
{
    ...
    {
        private DepartmentPosition(DepartmentPositionId id, DepartmentId departmentId, PositionMatrixId positionMatrixId)
        {
            this.id = id;
        ...
        public static DepartmentPosition Create(Department department, PositionMatrix positionMatrix)
        {
            return new DepartmentPosition(department, positionMatrix);
        }
 
        public DepartmentPosition(Department department, PositionMatrix positionMatrix)
        {
