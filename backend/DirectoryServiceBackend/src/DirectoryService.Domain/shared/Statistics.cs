...
namespace DirectoryService.Domain.shared
{
    ...
    {
        private Statistics(Guid id, Guid objectId, string objectTypeName, string userName , Level level, Action action, string description, DateTime dateTime, Guid? parentId, string? parentTypeName)
        {
            this.id = id;
        ...
        public static Statistics AddStatistics(Guid objectId, string objectTypeName, Level level, Action action, string description, Guid? parentId, string? parentTypeName)
        {
            ...
            return new Statistics(Guid.CreateVersion7(), objectId, objectTypeName, Environment.UserName, level, action, description, DateTime.Now, parentId, parentTypeName);
        }
        ...
        /// <param name="description"></param>
        /// <returns></returns>
        public static Statistics AddStatistics(Guid objectId, string objectTypeName, Level level, Action action, string description)
        {
            return AddStatistics(objectId, objectTypeName, level, action, description, null, null);
        }
